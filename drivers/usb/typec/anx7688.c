...
{
	struct anx7688 *anx7688 = timer_container_of(anx7688, t, work_timer);
...
static int anx7688_i2c_probe(struct i2c_client *client)
{
	...
	anx7688->vbus_in_supply =
		devm_power_supply_get_by_reference(dev, "vbus_in-supply");
...
static void anx7688_i2c_remove(struct i2c_client *client)
{
	...
	timer_delete_sync(&anx7688->work_timer);
