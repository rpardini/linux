		...
		IN boolean sco_hid, IN boolean tx_pause, IN u8 max_interval)
{
	...
	if (coex_dm->reset_tdma_adjust) {
		...
		if (retry_count ==
			...
			if (up >= n) {	/* if �s�� n ��2�� retry count��0, �h���eWiFi duration */
				wait_count = 0;
				n = 3;
				up = 0;
				dn = 0;
			...
			if (dn == 2) {	/* if �s�� 2 ��2�� retry count< 3, �h����WiFi duration */
				if (wait_count <= 2)
					m++; /* ���K�@���b����level�����^ */
				else
					m = 1;

				if (m >= 20)  /* m ���j�� = 20 ' ���j120�� recheck�O�_���� WiFi duration. */
					m = 20;
		...
		} else { /* retry count > 3, �u�n1�� retry count > 3, �h����WiFi duration */
			if (wait_count == 1)
				m++; /* ���K�@���b����level�����^ */
			else
				m = 1;
